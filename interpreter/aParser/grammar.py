grammar = {
	...
	70 : ('Dc', [b'drone', b'(', b'STRING', b')'], True),
	71 : ('Lla', [b'Ex', b',', b'Ex', b',', b'Ex'], True),
	72 : ('Fun', [b'move_to', b'(', b'ID', b',', b'Lla', b')'], True),
	73 : ('Fun', [b'rotate', b'(', b'ID', b',', b'Lla', b')'], True),
	74 : ('Fun', [b'print', b'(', b'Ex', b')'], True),
	75 : ('Fun', [b'speed', b'(', b'ID', b',', b'Ex', b')'], False),
	76 : ('Fun', [b'mission', b'(', b'ID', b',', b'Ex', b')'], False),
	77 : ('Ctrl', [b'For'], False),
	78 : ('Ctrl', [b'While'], False),
	79 : ('Ctrl', [b'If'], False),
	80 : ('For', [b'for', b'(', b'ID', b':', b'Ex', b',', b'Ex', b',', b'Ex', b')', b'{', b'Sx', b'}'], False),
	81 : ('While', [b'while', b'(', b'Ex', b')', b'{', b'Sx', b'}'], False),
	82 : ('If', [b'if', b'(', b'Ex', b')', b'{', b'Sx', b'}', b'El'], False),
	83 : ('El', [b'else', b'{', b'Sx', b'}'], False),
	84 : ('El', [b'elif', b'(', b'Ex', b')', b'{', b'Sx', b'}', b'El'], False),
	85 : ('El', [b'\xce\xb5'], False),
}
